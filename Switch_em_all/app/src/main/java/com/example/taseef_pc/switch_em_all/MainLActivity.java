...
public class MainLActivity extends Activity implements CvCameraViewListener,  View.OnTouchListener {
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    mOpenCvCameraView.setOnTouchListener(MainLActivity.this);
