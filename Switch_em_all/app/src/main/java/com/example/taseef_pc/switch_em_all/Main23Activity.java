...
public class Main23Activity extends Activity implements CvCameraViewListener,  View.OnTouchListener {
        ...
        public void onManagerConnected(int status) {
            switch (status) {
                case LoaderCallbackInterface.SUCCESS:
                {
                    ...
                    mOpenCvCameraView.setOnTouchListener(Main23Activity.this);
