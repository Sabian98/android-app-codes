...
public class Core {
  ...
  // */ public static Size getTextSize(String label, int fontface, double scale, int thickness, int[] baseline) {
    //}

    //public static void rectangle(Mat im, Point pt, Point pt1, Scalar scalar, int i) {
   // }

  ///  public static void putText(Mat im, String label, Point pt, int fontface, double scale, Scalar scalar, int thickness) {
   // }
//
