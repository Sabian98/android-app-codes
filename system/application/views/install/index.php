...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        <title>CHEMICAL DEPARTMENT ,BUET</title>
                ...
                <div id="steps">
                    <?php echo form_open('install/do_install' , array('id' => 'formElem' , 'name' => 'formElem'));?>
                        <fieldset class="step">
                            ...
                            <br><br><br><br><br><br>
                            <p>
                                Install this in few clicks.
                                <br>
                                Provide database information and admin settings,
                                <br>
                        ...
                        <fieldset class="step">
                            ...
                            <p>
                                <label for="namecard">Department name</label>
                                <textarea  name="system_name" AUTOCOMPLETE=OFF value="CHEMICAL DEPARTMENT,BUET"></textarea>
                            </p>
                            <p>
